...
if __name__ == '__main__':
  ...
  W9  = tf.Variable(tf.truncated_normal([3,3,3,NUM_FILTER_8,NUM_FILTER_9], stddev=0.1))
  ...
  W14 = tf.Variable(tf.truncated_normal([14*14*NUM_FILTER_13,NUM_NEURON_1], stddev=0.1))
  ...
  YY = tf.reshape(Y8_drop, shape=[-1,14*14*NUM_FILTER_13])


  Y14 = tf.nn.relu(tf.matmul(YY,W14)+b14)
  Y14_drop = tf.nn.dropout(Y9, keep_prob_1)
